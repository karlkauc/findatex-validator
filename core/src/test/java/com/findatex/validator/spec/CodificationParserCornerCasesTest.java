...
class CodificationParserCornerCasesTest {
    ...
    @CsvSource(delimiter = '|', value = {
            ...
            "YYYY-MM-DD                            | DATE",
            "YYYY-MM-DD  hh:mm:ss   ISO 8601 (UTC+0) | DATETIME",
            "YYYY-MM-DD HH:MM ISO 8601               | DATETIME",
            "YYYY-MM-DD / YYYY-MM-DD ; YYYY-MM-DD; YYYY-MM-DD ISO 8601 | DATE_LIST",
            "YYYY-MM-DD ; YYYY-MM-DD                  | DATE_LIST",
            "NACE V2.1 Code                        | NACE",
