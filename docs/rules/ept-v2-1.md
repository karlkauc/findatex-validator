# FinDatEx EPT Validation Reference (V2.1)

Spec: `/spec/ept/EPT_V2_1_20221012.xlsx`
Manifest: `/spec/ept/ept-v21-info.json`
Released: 2022-10-12  ·  Sheet: `EPT 2.1 `
Profiles: PRIIPs Sync (`PRIIPS_SYNC`), PRIIPs KID (`PRIIPS_KID`), UK (`UK`)
...
- **Active rule instances:** 66 (one per field × profile).
...
- **Active rule instances:** 44 (one per CIC-restricted field × profile).
...
- **Active rule instances:** 144 (one per field).
...
| `UK` | UK | — | Profile column not present in this version. |
...
### Field 73a — 03040_One_Off_Costs_Portfolio_Exit_Cost_At_Half_RHP
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/73a/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/73a` | (all) | ERROR | Populated cell does not match the codification (NUMERIC) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |
...
Codification: FREE_TEXT
Applicability: all rows
Definition: Describes the dependence of costs on the invested amount, not more than 150 characters.
...
### Field 121 — 07110_Incidental_Costs_Portfolio_Performance_Fees_Carried_Interest
...
### Field 122 — 08010_UK_PRIIP_Or_UCITS_Or_Both_data_delivery

Codification: FREE_TEXT
Applicability: all rows
Definition: Indicates if the line contains UK PRIIPs data, UCITS data or Both
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/122/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
...
### Field 123 — 08020_UK_Ongoing_Costs_Portfolio_Transaction_Costs

Codification: NUMERIC
Applicability: all rows
Definition: See UK PRIIPs definition for PRIIPs other than UCITS/NURS. UCITS/NURS may follow alternative definitions. Express as a % of NAV of the portfolio, the funds or the share class / per annum.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/123/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/123` | (all) | ERROR | Populated cell does not match the codification (NUMERIC) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 124 — 08030_UK_Transactions_costs_methodology

Codification: FREE_TEXT
Applicability: all rows
Definition: 1. New PRIIPS methodology 2. Full UK PRIIPS methodology 3. Other methodology
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/124/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/124` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 125 — 08040_UK_Anti_Dilution_Benefit_Derived

Codification: NUMERIC
Applicability: all rows
Definition: Information about the total benefit derived from an anti-dilution mechanism
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/125/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/125` | (all) | ERROR | Populated cell does not match the codification (NUMERIC) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 125a — 08045_UK_PRIIPs_Data_Reference_Date

Codification: DATE
Applicability: all rows
Definition: The date to which the UK PRIIPs data in this section relates
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/125a/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/125a` | (all) | ERROR | Populated cell does not match the codification (DATE) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 126 — 08050_UK_PRIIPs_KID_Publication_Date

Codification: DATE
Applicability: all rows
Definition: Date of the latest UK PRIIPs KID produced for the portfolio or share class.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/126/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/126` | (all) | ERROR | Populated cell does not match the codification (DATE) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 127 — 08060_UK_PRIIPs_KID_Web_Address

Codification: FREE_TEXT
Applicability: all rows
Definition: Direct link to the UK PRIIPs KID
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/127/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/127` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 128 — 08070_Investment_Objective_Portfolio
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/128/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/128` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 129 — 08080_UK_Other_Materially_Relevant_Risk_Narrative_Portfolio
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/129/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/129` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 130 — 08090_UK_Performance_Information_Main_Factors

Codification: FREE_TEXT
Applicability: all rows
Definition: A description of the main factors likely to affect future returns for the investor, identifying those most likely to determine the outcome of the investment and other factors which could have a material impact on performance.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/130/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
...
### Field 131 — 08100_UK_Performance_Information_Comparator

Codification: FREE_TEXT
Applicability: all rows
Definition: Identification of the most relevant index, benchmark, target, or proxy, as applicable, along with an explanation of how the PRIIP is likely to compare in terms of performance and volatility.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/131/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/131` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 132 — 08110_UK_Performance_Information_Higher_Returns

Codification: FREE_TEXT
Applicability: all rows
Definition: A brief explanation of the kinds of conditions that would be conducive to the PRIIP generating higher returns.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/132/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/132` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 133 — 08120_UK_Performance_Information_Lower_Returns_Or_Loss

Codification: FREE_TEXT
Applicability: all rows
Definition: A brief explanation of the kinds of conditions whereby the PRIIP is likely to generate lower returns or lead to investment loss.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/133/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
...
### Field 134 — 08130_UK_Performance_Information_Adverse_Conditions

Codification: FREE_TEXT
Applicability: all rows
Definition: A brief description of what outcome the investor may expect where the PRIIP matures or is redeemed or encashed under severely adverse market conditions.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/134/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
...
### Field 135 — 08140_UK_Assumed_Portfolio_Return

Codification: NUMERIC
Applicability: all rows
Definition: The performance used as the annual internal rate of return for estimating future benefit payments when calculating summary cost indicators
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/135/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
...
### Field 136 — 08150_UCITS_KIID_Publication_Date

Codification: DATE
Applicability: all rows
Definition: Date of the latest UCITS KIID produced for the portfolio or share class.
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/136/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/136` | (all) | ERROR | Populated cell does not match the codification (DATE) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 137 — 08160_UCITS_KIID_Web_Address

Codification: FREE_TEXT
Applicability: all rows
Definition: Direct link to the UCITS KIID
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/137/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/137` | (all) | ERROR | Populated cell does not match the codification (FREE_TEXT) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 138 — 08170_UCITS_SRRI

Codification: NUMERIC
Applicability: all rows
Definition: The SRRI of the Valid UCITS KIID
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/138/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
| `FORMAT/138` | (all) | ERROR | Populated cell does not match the codification (NUMERIC) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |


---

### Field 139 — 08180_UCITS_Ongoing_Charges

Codification: NUMERIC
Applicability: all rows
Definition: See UCITS definition as a % of NAV of the portfolio, the funds or the share class / per annum
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/139/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
...
### Field 140 — 08190_UCITS_Existing_Performance_Fees
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `PRESENCE/140/PRIIPS_KID` | PRIIPs KID | ERROR | Cell is empty for an active row of profile PRIIPs KID | The mandatory cell is missing — file is incomplete for this profile. | MANDATORY_COMPLETENESS −1/N, PROFILE_COMPLETENESS (M leg) −1/N |
...
### Field 141 — 08200_UCITS_Performance_Fees
...
| Rule ID | Profile(s) | Severity | Triggers when | Failure consequence | Score impact |
|---|---|---|---|---|---|
| `COND_PRESENCE/141/PRIIPS_KID` | PRIIPs KID | WARNING | Row's CIC matches the field's applicability list and the cell is empty | Conditionally-required cell missing for this profile. | PROFILE_COMPLETENESS (C leg) −1/N |
| `FORMAT/141` | (all) | ERROR | Populated cell does not match the codification (NUMERIC) | Value cannot be parsed/used downstream. | FORMAT_CONFORMANCE −1/M (or CLOSED_LIST_CONFORMANCE −1/M for closed-list mismatches) |
