# FinDatEx TPT Validation Reference (V7.0)

Spec: `/spec/tpt/TPT_V7_20241125.xlsx`
Manifest: `/spec/tpt/tpt-v7-info.json`
Released: 2024-11-25  ·  Sheet: `TPT V7.0`
...
- **Active rule instances:** 82 (one per CIC-restricted field × profile).
...
- **Active rule instances:** 152 (one per field).
...
Path: `Expected redemption date after considering an expected prepayment / extension of the contractual terms based on the options in the instrument`
Codification: DATE
Applicability: all rows
...
### Field 148 — 148_Economic_sector_NACE2.1
